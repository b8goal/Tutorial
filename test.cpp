...
public:
  ...
  int ID_;
  std::shared_ptr<Particle> circular_ptr;
};
...
{
  data1->circular_ptr = data2;
  data2->circular_ptr = data1;

  std::cout << "data1's ID: " << data1->circular_ptr << std::endl;
  std::cout << "data2's ID: " << data2->circular_ptr << std::endl;
}
